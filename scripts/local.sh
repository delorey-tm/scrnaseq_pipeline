...
sample_tracking_file="${gcp_bucket_basedir}/020323_batch2_gex_sampletracker.csv"
...
dsub --provider google-cls-v2 --project "microbiome-xavier" --regions us-east1 \
  ...
  --command "wget https://github.com/delorey-tm/scrnaseq_pipeline/archive/master.zip && unzip master.zip && cd scrnaseq_pipeline-master/src && python sc_pipeline.py" \
