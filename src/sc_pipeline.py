...
sample_tracking_file = os.getenv("SAMPLE_TRACKING_FILE", default="../data/020323_batch2_gex_sampletracker.csv")
gcp_basedir = os.getenv("GCP_BUCKET_BASEDIR", default="gs://fc-secure-d4adbbf9-8265-4a5c-b14f-23a5f1b5c4f9/finngen_gex")
email = os.getenv("EMAIL", default="delorey@broadinstitute.org")
...
mkfastq_memory = os.getenv("MKFASTQ_MEMORY", default="256G")
